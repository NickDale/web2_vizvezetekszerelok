...
if (str_starts_with($request, REST_API_PATH)) {
	$url = str_replace(REST_API_PATH, "", $request);
	require_once('rest/rest-api-controller.php');

	$restController = new RestApiController($url);
} else {
	if ($request != "") {
